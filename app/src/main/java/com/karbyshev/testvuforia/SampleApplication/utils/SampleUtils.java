...
package com.karbyshev.testvuforia.SampleApplication.utils;
...
public class SampleUtils {
    ...
    public static int createTexture(Image image) {
        ...
        GLES20.glTexImage2D(GLES20.GL_TEXTURE_2D, 0, format, texture.mWidth, texture.mHeight, 0,
                format, type, texture.mData);
