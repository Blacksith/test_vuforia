...
package com.karbyshev.testvuforia.SampleApplication;
...
import static com.karbyshev.testvuforia.SampleApplication.SampleApplicationException.CAMERA_INITIALIZATION_FAILURE;
import static com.karbyshev.testvuforia.SampleApplication.SampleApplicationException.INITIALIZATION_FAILURE;
import static com.karbyshev.testvuforia.SampleApplication.SampleApplicationException.VUFORIA_ALREADY_INITIALIZATED;
    ...
    private void startCameraAndTrackers(int camera) throws SampleApplicationException {
        ...
        if (mCameraRunning) {
            ...
            throw new SampleApplicationException(
                    CAMERA_INITIALIZATION_FAILURE, error);
        }
    ...
    private static class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            synchronized (session.mLifecycleLock) {
                Vuforia.setInitParameters(session.mActivityRef.get(),
                        session.mVuforiaFlags,
                        "");
